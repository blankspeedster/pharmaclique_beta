                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <a href="#collapseStore" class="d-block card-header py-3" data-toggle="" role="button" aria-expanded="true" aria-controls="collapseStore">
                                        <h6 class="m-0 font-weight-bold text-primary">Chat Thread with <?php echo $transactionInfo["firstname"] . " " . $transactionInfo["lastname"]; ?></h6>
                                    </a>
                                    <div class="card-body">
                                        <div class="row">
                                                ...
                                                <div class="card shadow row no-gutters align-items-center p-4">
                                                    <div class="col mr-2">
                                                        <div v-for="c in chats">
                                                            ...
                                                            <div v-if="c.user === 'customer' " class="containerChat">
                                                                <label class="text-xs font-weight-bold text-uppercase"><?php echo $transactionInfo["firstname"] . " " . $transactionInfo["lastname"]; ?></h6></label>
                                                                <p>{{c.user_message}}</p>
                                                                <span class="text-xs">{{c.updated_at}}</span>
                                                            </div>

                                                            <div v-if="c.user === 'pharmacy' " class="containerChat darker">
                                                        ...
                                                        <div class="text-xs font-weight-bold text-primary mb-1">
                                                            <form @submit.prevent="sendMessage()">
                                                                <div class="mb-2">
                                                                    <textarea v-model="chatMessage" class="form-control" placeholder="Send message to customer." style="min-height: 100px;" required></textarea>
                                                                </div>
                                                                <div class="mb-2">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <a href="#collapseStore" class="d-block card-header py-3" role="button" aria-expanded="true" aria-controls="collapseStore">
                                        <h6 class="m-0 font-weight-bold text-primary">Prescription for this transaction</h6>
                                    </a>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-xl-12 col-md-12 mb-4">
                                                ...
                                                <div class="card shadow row no-gutters align-items-center p-4">
                                                    <div class="col mr-2">
                                                        ...
                                                        <div class="h5 mb-0 font-weight-bold text-gray-800 text-center">
                                                            <img :src="'../img/'+transactions.prescription_url" style="max-height:100%; min-width: 80%; max-width: 80%; border-radius: 10px;">
                                                        </div>
                                                        <div class="text-xs font-weight-bold text-primary mb-1">
                                                            <div class="mb-2">
            ...
            new Vue({
                ...
                methods: {
                    ...
                    async uploadPrescriptionPicture() {
                        ...
                        const options = {
                            method: "POST",
                            url: "process_booking.php?uploadPrescriptionPicture=" + <?php echo $transaction_id; ?>,
                            headers: {
