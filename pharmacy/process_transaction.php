...
if(isset($_GET['sendMessage'])){
    ...
    $mysqli->query("INSERT INTO transaction_threads (transaction_id, user, user_message, updated_at) VALUES ('$transaction_id', 'pharmacy', '$chat_message', '$updated_at' )") or die($mysqli->error);
}
