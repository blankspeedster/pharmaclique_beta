...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 19, 2022 at 03:31 PM
...
(9, 2, 21, 3, 4, '2952.00', '2952.00', 0, '2022-03-19 19:18:07', 0),
(10, 2, 1, 1, 2, '10.00', '20.00', 0, '2022-03-19 19:30:23', 0),
(12, 2, 3, 1, 3, '12.00', '36.00', 0, '2022-03-19 19:30:24', 0),
(13, 2, 8, 2, 1, '20.00', '20.00', 0, '2022-03-19 19:30:25', 0),
(14, 2, 22, 3, 1, '9999999999.99', '9999999999.99', 0, '2022-03-19 19:30:26', 0);
...
(2, 'Customer', 'Customer', 'customer', '09000000000', '$2y$10$BFzaFb8UHuithQH2yKdTBuChuUenSOWQGy628Myuj/QlsI/WVDWn.', 2, 1),
...
--
ALTER TABLE `transaction`
  ADD CONSTRAINT `transaction_ibfk_1` FOREIGN KEY (`pharmacy_id`) REFERENCES `pharmacy_store` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
