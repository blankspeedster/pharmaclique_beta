                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-xl-12 col-md-12 mb-4">
                                                ...
                                                <div class="card shadow row no-gutters align-items-center p-4">
                                                    <span v-if="bookings.prescription == '0' ">The prescription below is just a template. You may ask the <b>Dr. <?php echo $bookingInfo["firstname"] . " " . $bookingInfo["lastname"]; ?></b> to provide an e-prescription.</span>
                                                    <div class="col mr-2">
